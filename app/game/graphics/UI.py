...
class UI:
    ...
    def update_ui_surface(self, sun, nutrients, water):
        self._surfaces["sun"]["surface"] = self._font.render(self._surfaces["sun"]["text"].format(value=sun), True, (0, 0, 0))
        self._surfaces["nut"]["surface"] = self._font.render(self._surfaces["nut"]["text"].format(value=sun), True, (0, 0, 0))
        self._surfaces["wat"]["surface"] = self._font.render(self._surfaces["wat"]["text"].format(value=sun), True, (0, 0, 0))
